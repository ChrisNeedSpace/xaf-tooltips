...
<head runat="server">
	...
	<script type="text/javascript">
		...
		//});
        --%>
		$(document).on("mouseover", ".Layout .Caption", function () {
		    $(".Layout .Caption").tooltip({
		       hide: { effect: "HACK_nonexisiting_effect", duration: 300 }, // otherwise tooltips don't close.
		       content: function () { return $(this).attr('title') || ""; }
		    });
		});		
    </script>
...
<script type="text/javascript" src="scripts/MoveFooter.js"> </script>
